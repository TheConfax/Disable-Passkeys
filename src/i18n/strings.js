window.LOCALES = {
  ...
  fr: {
    ...
    about_intro_body: "Il continue de travailler dans l'ombre, en tenant les invites de passkey à l'écart, pour te connecter comme tu veux.",
    about_stat_label: "invites de passkey évitées",
    about_stat_label_1: "invite de passkey évitée",
    about_stat_caption_0: "Mais quand un site demandera une passkey, tu ne le remarqueras même pas.",
    about_stat_caption_1: "Ta première interruption a été évitée, et ce ne sera pas la dernière.",
    about_stat_caption_few: "Tes premières interruptions ont été évitées, et ce ne seront pas les dernières.",
    about_stat_caption_many: "Cela fait beaucoup d'interruptions que tu n'as jamais eu à gérer, et ce n'est pas fini.",
    about_support_heading: "Tu apprécies le silence ?",
    about_support_body: "Disable Passkeys est gratuit et le restera toujours.\nS'il t'a épargné un tracas, pense à faire un don.",
    ...
    support_donated_heading: "Tu as fait tomber ça, roi. 👑",
    ...
    whatsnew_intro_2: "<strong>Login</strong>, <strong>Autoremplissage</strong> et <strong>Création</strong> se désactivent maintenant un par un, pour écarter l'invite qui te gêne tout en continuant à te connecter depuis le menu déroulant des passkeys.",
